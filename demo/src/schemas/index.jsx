...
export const page1Schema = Yup.object({
    ...
    apigee_network_name: Yup.string().min(4).max(14).required("Please enter apigee network name"),
    ...
    apigee_network_main_peering_range_prefix_length: Yup.string().min(2).max(2).required("Please enter apigee network prefix length"),
    apigee_network_support_peering_range: Yup.string().min(4).max(12).required("Please enter apigee network peering range"),
    apigee_network_support_peering_range_prefix_length: Yup.string().min(2).max(2).required("Please enter apigee network prefix length"),
...
export const page4Schema = Yup.object({
  psc_ingress_network_name: Yup.string().min(4).max(20).required("Please enter apigee organization key ring name"),
